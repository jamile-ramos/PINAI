...
$(document).ready(function () {
    ...
    // Mantém um item de menu ativo mesmo após recarregar ou navegar para outra página
    $(document).ready(function () {
    ...
    // Clicar no icone noticia e aparece a barra de pesquisa
    $(document).ready(function () {
