...
$(document).ready(function () {
    ...
    $(document).ready(function () {
        ...
        if (window.location.href.indexOf("dashboard") > -1) {
            activeItem = "/dashboard";  // Ajuste o seletor conforme o seu código de navegação
        }
        ...
        if (activeItem) {
            ...
            // Adiciona a classe "active" ao item armazenado no localStorage
            $(".nav-item a[href='" + activeItem + "']").parent().addClass("submenu active");
        }
        
        // Armazenando o item ativo no localStorage quando o item for clicado
        $(".nav-item a").on("click", function () {
            // Remove a classe "active" de todos os itens de navegação
            $(".nav-item").removeClass("submenu active");
    
            // Verifica se o item clicado já está com a classe "show"
            if (!$(this).parent().find(".collapse").hasClass("show")) {
                // Adiciona a classe "submenu active" apenas ao item clicado
                $(this).parent().addClass("submenu active");
    
                // Armazenar o item ativo no localStorage (você pode usar o href ou um identificador exclusivo)
